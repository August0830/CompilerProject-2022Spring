...
ExtDef :      Specifier ExtDecList SEMI {$$ = newNonterminatorToken(NOT_TOKEN,@$.first_line,"ExtDef",3,$1,$2,$3);}
  ...
  |           Specifier FuncDec CompSt  {$$ = newNonterminatorToken(NOT_TOKEN,@$.first_line,"ExtDef",3,$1,$2,$3);}
...
VarDec : ID                             {$$ = newNonterminatorToken(NOT_TOKEN,@$.first_line,"VarDec",1,$1);}
  ...
  | error RB                            {synError = 1;}
  ;
FuncDec : ID LP VarList RP              {$$ = newNonterminatorToken(NOT_TOKEN,@$.first_line,"FuncDec",4,$1,$2,$3,$4);}      
  | ID LP RP                            {$$ = newNonterminatorToken(NOT_TOKEN,@$.first_line,"FuncDec",3,$1,$2,$3);}
  | error RP                            {synError = 1;}
  ;
